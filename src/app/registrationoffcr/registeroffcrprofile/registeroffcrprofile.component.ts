...
@Component({
  selector: 'app-registeroffcrprofile',
  templateUrl: './registeroffcrprofile.component.html',
  styleUrls: ['./registeroffcrprofile.component.css']
})
export class RegisteroffcrprofileComponent {
    ...
    ngOnInit() {
      ...
      this.getStatesByID();
      this.getLocalGovermnttByID();
      this.getLocalGovtByID();
    ...
    initialiseOnboardConsumerForms() {
      this.onboardConsumerForm = this.formBuilder.group({
        ...
        countryId: new FormControl({ value: "1", disabled: true },[Validators.required]),
        stateId:  new FormControl({ value: "24", disabled: true},[Validators.required]),
    ...
    getStatesByID() {
      ...
      this.waterService.getStatesByID(1).subscribe((data: any) => { this.stateData = data.response; },);
    }
    ...
    getLocalGovtByID() {
      ...
      this.waterService.getLocalGovtByID(24).subscribe((data: any) => { this.localGovermntData = data.response; },);
    }
    getLocalGovermnttByID() {
      let countryId = this.onboardConsumerForm.get('stateId')!.value;
      this.waterService.getLocalGovtByID(24).subscribe((data: any) => { this.localeGovtData = data.response; },);
    }
    ...
    public setItemsPerPage($event: any) {
      ...
      this.router.navigate(["/registrationprofiling"]); 
    ...
    onSubmitRASConsumerSearch(){
      ...
      this.onSubmitConsumerSearch(this.configRAS.itemsPerPage, this.configRAS.currentPage);
    }
      ...
      this.httpClient
        ...
        .subscribe((data) => {
          ...
          if (data.status == true && data.response != null) {
            ...
            this.configRAS.totalItems = data.response?.total;
            this.configRAS.currentPage = data.response?.current_page;
            this.submittedsearchRas = false;
          }
    ...
    onSubmitAsstSearch(){
      ...
      this.onSubmitAssetSearch(this.configAsset.itemsPerPage, this.configAsset.currentPage);
    }
      ...
      this.httpClient
        ...
        .subscribe((data) => {
          ...
          if (data.status == true && data.response != null) {
            ...
            this.configAsset.totalItems = data.response?.assets.total;
            this.configAsset.currentPage = data.response?.assets.current_page;
            this.submittedSearchAsset = false;
    ...
    pageChange(newPage: number) {
      if(this.activeTab == 'consumerAsset'){
        ...
        this.onSubmitAssetSearch(this.configAsset.itemsPerPage, newPage);
      }   
     else if(this.searchedConsumerData) {
        this.router.navigate(["/registrationprofiling"], {
        });
        this.onSubmitConsumerSearch(this.configRAS.itemsPerPage, newPage);
      }
    else{
      this.router.navigate(["/registrationprofiling"], {
    ...
    public setItemsPerPageCons($event: any) {
      this.configRAS.itemsPerPage = $event;
      this.configRAS.currentPage = 1;
      this.currentPageConsumerLength = this.configRAS.itemsPerPage;
      this.router.navigate(["/registrationprofiling"]);
      this.onSubmitConsumerSearch(this.configRAS.itemsPerPage, 1);
    }
    ...
    public setItemsPerPageRas($event: any) {
      this.configAsset.itemsPerPage = $event;
      this.configAsset.currentPage = 1;
      this.currentPageRasLength = this.configAsset.itemsPerPage;
      this.router.navigate(["/registrationprofiling"]);
      this.onSubmitAssetSearch(this.configAsset.itemsPerPage, 1);
    }
    clickExistingAssets() {
     // this.activeTab = "";
      this.config = {
