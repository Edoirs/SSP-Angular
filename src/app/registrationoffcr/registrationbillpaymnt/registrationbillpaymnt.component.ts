...
@Component({
  selector: 'app-registrationbillpaymnt',
  templateUrl: './registrationbillpaymnt.component.html',
  styleUrls: ['./registrationbillpaymnt.component.css']
})
export class RegistrationbillpaymntComponent {
