...
@Component({
  selector: 'app-headbillingprofilereq',
  templateUrl: './headbillingprofilereq.component.html',
  styleUrls: ['./headbillingprofilereq.component.css']
})
export class HeadbillingprofilereqComponent implements OnInit {
    ...
    public setItemsPerPage($event: any) {
      ...
      this.router.navigate(["/headbillingprofilerequest"]);
