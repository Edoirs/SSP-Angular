...
@Component({
  selector: 'app-headbliingconsumerlist',
  templateUrl: './headbliingconsumerlist.component.html',
  styleUrls: ['./headbliingconsumerlist.component.css']
})
export class HeadbliingconsumerlistComponent {
    ...
    public setItemsPerPage($event: any) {
      ...
      this.router.navigate(["/headbillingprofile"]);
  ...
  onSubmitConsumerSearch(perpage: any, pageno: any) {
    ...
    this.router.navigate(["/headconsumer"]);
