...
@Component({
  selector: 'app-headbilligcreatebill',
  templateUrl: './headbilligcreatebill.component.html',
  styleUrls: ['./headbilligcreatebill.component.css']
})
export class HeadbilligcreatebillComponent {
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/headbillingcreatebill"]);
    ...
    this.httpClient
      ...
      .subscribe((data) => {
        if (data.status == true) {
          ...
          // this.router.navigate(["/headreturningpatient"]);
        }
        else {
          Swal.fire({
            icon: "error",
