...
@Component({
  selector: 'app-headbillingsettlements',
  templateUrl: './headbillingsettlements.component.html',
  styleUrls: ['./headbillingsettlements.component.css']
})
export class HeadbillingsettlementsComponent implements OnInit {
      userId: any
      ...
      public setItemsPerPage($event: any) {
        ...
        this.router.navigate(["/headbillingsettlement"]); 
