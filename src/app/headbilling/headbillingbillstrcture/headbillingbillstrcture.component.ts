...
@Component({
  selector: 'app-headbillingbillstrcture',
  templateUrl: './headbillingbillstrcture.component.html',
  styleUrls: ['./headbillingbillstrcture.component.css']
})
export class HeadbillingbillstrctureComponent{
      ...
      category(activeTab: string, $event: MouseEvent): void {
        ...
        this.router.navigate(["/headbillingstructure"]);
          this.config = {
            currentPage: 1,
            itemsPerPage: 10,
          };
