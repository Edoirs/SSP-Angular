...
@Component({
  selector: 'app-billingreportsbills',
  templateUrl: './billingreportsbills.component.html',
  styleUrls: ['./billingreportsbills.component.css']
})
export class BillingreportsbillsComponent {
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/billinggeneratedbill"]);
