...
@Component({
  selector: 'app-billingprofilereq',
  templateUrl: './billingprofilereq.component.html',
  styleUrls: ['./billingprofilereq.component.css']
})
export class BillingprofilereqComponent implements OnInit {
      ...
      public setItemsPerPage($event: any) {
        ...
        this.router.navigate(["/billingprofilereq"]);
