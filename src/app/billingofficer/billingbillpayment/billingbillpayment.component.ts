...
@Component({
  selector: 'app-billingbillpayment',
  templateUrl: './billingbillpayment.component.html',
  styleUrls: ['./billingbillpayment.component.css']
})
export class BillingbillpaymentComponent {
  ...
  partialPay(singleBillData: any, modal: any) {
    ...
    //   this.groupPaymentItemsForm.reset();
    this.submitted = false;
    this.showModal(modal);
  }
  clearSearch() {
