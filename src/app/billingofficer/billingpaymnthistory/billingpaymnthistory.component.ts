...
@Component({
  selector: 'app-billingpaymnthistory',
  templateUrl: './billingpaymnthistory.component.html',
  styleUrls: ['./billingpaymnthistory.component.css']
})
export class BillingpaymnthistoryComponent {
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/billingpaymenthistory"]);
