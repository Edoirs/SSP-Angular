...
@Component({
  selector: 'app-headictsettlements',
  templateUrl: './headictsettlements.component.html',
  styleUrls: ['./headictsettlements.component.css']
})
export class HeadictsettlementsComponent implements OnInit {
    ...
    public setItemsPerPage($event: any) {
      ...
      this.router.navigate(["/headsettlement"]); 
