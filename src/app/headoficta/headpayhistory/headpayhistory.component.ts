...
@Component({
  selector: 'app-headpayhistory',
  templateUrl: './headpayhistory.component.html',
  styleUrls: ['./headpayhistory.component.css']
})
export class HeadpayhistoryComponent {
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/headpaymenthistory"]);
