...
@Component({
  selector: 'app-headconsumerlisting',
  templateUrl: './headconsumerlisting.component.html',
  styleUrls: ['./headconsumerlisting.component.css']
})
export class HeadconsumerlistingComponent {
