...
@Component({
  selector: 'app-headcreatebill',
  templateUrl: './headcreatebill.component.html',
  styleUrls: ['./headcreatebill.component.css']
})
export class HeadcreatebillComponent {
  userId: any
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/headbills"]);
