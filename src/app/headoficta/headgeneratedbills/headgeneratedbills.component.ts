...
@Component({
  selector: 'app-headgeneratedbills',
  templateUrl: './headgeneratedbills.component.html',
  styleUrls: ['./headgeneratedbills.component.css']
})
export class HeadgeneratedbillsComponent {
 ...
 clearSearch() {
  ...
  public setItemsPerPage($event: any) {
    ...
    this.router.navigate(["/headgeneratedbills"]);
